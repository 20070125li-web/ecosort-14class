...
class EfficientNetClassifier(nn.Module):
    ...
    def __init__(
        ...
        # Build EfficientNet with the requested backbone.
        # Important: even when pretrained=False, we must keep the same backbone
        # architecture (e.g., b3) to match checkpoint tensor shapes.
        if pretrained:
